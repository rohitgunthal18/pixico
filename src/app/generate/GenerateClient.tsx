...
export default function GenerateClient({ initialConversations }: GenerateClientProps) {
    ...
    // Load conversations if user changes or if they weren't provided
    useEffect(() => {
        if (user && (!initialConversations || initialConversations.length === 0)) {
            loadConversations();
        }
